    ...
    return (
        <div className="addUser-form-container">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="addUser-form-group">
                    <label className="addUser-label">Confirm Password:</label>
                    <input className="addUser-input" type="password" name="confirmedPassword" value={formData.confirmedPassword} onChange={handleChange} required />
                </div>
                <div className="addUser-form-group">
                    <label className="addUser-label">Phone:</label>
                    <input className="addUser-input" type="number" name="phone" value={formData.phone} onChange={handleChange} required />
                </div>
                <div className="addUser-form-group">
                ...
                <div className="addUser-form-group">
                    <label className="addUser-label">Status:</label>
                    <select className="addUser-select" name="status" value={formData.status} onChange={handleChange} required>
                        <option value="">Select Status</option>
                        <option value={true}>Active</option>
                        <option value={false}>Inactive</option>
                    </select>
                </div>
                <button className="addUser-button" type="submit">Submit</button>
            </form>
        </div>
    );
};
